...
const Sidebar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `
<div class="${"grid grid-cols-[auto_1fr] h-full " + escape($$props.class ?? "", true)}">${validate_component(AppRail, "AppRail").$$render(
    $$result,
    {
    ...
    <section class="p-4 pb-20 space-y-4 overflow-y-auto">${each(filteredMenuNavLinks, ({ id, title, list }, i) => {
    return `${list.length > 0 ? `
                <div${add_attribute("id", id, 0)} class="text-primary-700 dark:text-primary-500 font-bold uppercase ps-4">${escape(title)}</div>
